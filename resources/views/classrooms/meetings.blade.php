                    ...
                    <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg border-l-8 {{ $meeting->meeting_date < now() ? 'border-gray-300' : 'border-green-500' }}">
                        <div class="p-6 flex flex-col md:flex-row md:items-center justify-between">
                            ...
                            <div class="flex flex-wrap gap-3">
                                <a href="{{ route('meetings.roll-call', [$classroom->id, $subject->id, $meeting->id]) }}" class="inline-flex items-center px-4 py-2 bg-indigo-600 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-indigo-700">
